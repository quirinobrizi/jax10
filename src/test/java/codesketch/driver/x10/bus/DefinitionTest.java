...
public class DefinitionTest {
	...
	/**
	 * Test method for
	 * {@link codesketch.driver.x10.Module#isValidDevice(short, short)}.
	 */
	@Test
	public void testIsKnownDevice_validDefinition() {
		Module definition = Module.CM15;
		boolean valid = Module.isValidDevice(definition.getVendorId(), definition.getProductId());
		assertTrue(valid);
	}
	...
	public void testIsKnownDevice_invalidDefinition() {
		boolean valid = Module.isValidDevice((short) 0x12ab4, (short) 0x3c44);
		assertFalse(valid);
	}
