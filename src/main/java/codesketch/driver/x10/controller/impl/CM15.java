...
public class CM15 extends AbstractUsbX10Controller {
	...
	public String toString() {
		...
		builder.append("CM15 [").append("vendorId: ").append(vendorId()).append(", productId: ").append(productId()).append("]");
	...
	public boolean equals(Object obj) {
		...
		return equalsBuilder.append(vendorId(), other.vendorId()).append(productId(), other.productId()).isEquals();
	}
	...
	public int hashCode() {
		...
		return hashCodeBuilder.append(vendorId()).append(productId()).toHashCode();
	}
